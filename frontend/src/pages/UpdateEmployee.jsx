                ...
                <div className='my-2 flex w-full border-t pt-2'>
                    ...
                    <div className='flex flex-col basis-1/2 '>
                        <div className='w-full'>
                            ...
                            <input type="radio" name='Designation' id='HR' value='HR' checked={user.f_Designation === 'HR'} className='ml-20 basis-1/2' onClick={(e) => setUser({ ...user, f_Designation: e.target.value })}  />

                        </div>
                        <div className='w-48'>
                            <label htmlFor="Manager" className='text-gray-600  mb-1 basis-1/2'>Manager</label>
                            <input type="radio" name='Designation' id='Manager' value='Manager' checked={user.f_Designation === 'Manager'} className='ml-7 basis-1/2' onClick={(e) => setUser({ ...user, f_Designation: e.target.value })}  />
                        </div>
                        <div className='w-32'>
                            <label htmlFor="Sales" className='text-gray-600  mb-1 basis-1/2'>Sales</label>
                            <input type="radio" name='Designation' id='Sales' value='Sales' checked={user.f_Designation === 'Sales'} className='ml-[58px] basis-1/2' onClick={(e) => setUser({ ...user, f_Designation: e.target.value })}  />
                        </div>
                ...
                <div className='my-2 flex w-full border-t pt-2'>
                    ...
                    <div className='flex flex-col basis-1/2 '>
                        <div className='w-full'>
                            ...
                            <input type="radio" name='Gender' id='Male' value='Male' checked={user.f_Gender === 'Male'} onClick={(e) => setUser({ ...user, f_Gender: e.target.value })} className='ml-14 basis-1/2'  />

                        </div>
                        <div className='w-48'>
                            <label htmlFor="Female" className='text-gray-600  mb-1 basis-1/2'>Female</label>
                            <input type="radio" name='Gender' id='Female' value="Female" checked={user.f_Gender === 'Female'} onClick={(e) => setUser({ ...user, f_Gender: e.target.value })} className='ml-9 basis-1/2' />
                        </div> 
                ...
                <div className='my-2 flex w-full border-t pt-2'>
                    ...
                    <div className='flex flex-col basis-1/2 '>
                        <div className='w-full'>
                            ...
                            <input type="radio" name='Status' id='Active' value='Active' checked={user.f_Status === true} onClick={(e) => setUser({ ...user, f_Status: true })} className='ml-14 basis-1/2'  />

                        </div>
                        <div className='w-48'>
                            <label htmlFor="Deactive" className='text-gray-600  mb-1 basis-1/2'>Deactive</label>
                            <input type="radio" name='Status' id='Deactive' value="Deactive" checked={user.f_Status === false} onClick={(e) => setUser({ ...user, f_Status:false })} className='ml-9 basis-1/2' />
                        </div> 
